...
<head>
    ...
    <title>Gerenciar Reservas | XepaViva</title>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto align-items-center">
                    ...
                    <li class="nav-item"><a class="nav-link" href="minhas-ofertas.php"><i class="bi bi-list-check me-1"></i>Minhas Ofertas</a></li>
                    <li class="nav-item"><a class="nav-link active" href="gerenciar-reservas.php" aria-current="page"><i class="bi bi-calendar-check-fill me-1"></i>Gerenciar Reservas</a></li>
